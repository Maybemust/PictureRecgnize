...
void find(int num,Mat image)
{
	...
	sample1 = imread("/home/liyang/worktree2018/avoidcollision/imagered.jpg");
	sample2 = imread("/home/liyang/worktree2018/avoidcollision/imageyello.jpg");	
	sample3 = imread("/home/liyang/worktree2018/avoidcollision/imageblue.jpg");
...
void AvoidCollision::start()
{
 ...
 //        	waitKey(50);
	...
	motionProxy.moveToward(1, 0.3, 0, config);                 //   能否准确到达 终点
